...
var country_regions = new Array(4); // 4 regions = Africa&Middle East + America + Asia-Pacific + Europe
country_regions[0] = new Array("Afghanistan", "Central African Republic", "South Africa", "Egypt", "Iraq", "Israel", "Middle East", "North Africa", "Saudi Arabia"); // Africa&Middle East
country_regions[1] = new Array("Afghanistan", "Africa", "South Africa", "Egypt", "Iraq", "Israel", "Middle East", "North Africa", "Saudi Arabia"); // Africa&Middle East
...
function checkCountries()
{
	...
	var y = 0;
	for (x = 0; x < 4; x++) {
		for (y = 0; y < country_regions[x].length; y++) {
			if ($.inArray(country_regions[x][y], country_arr) < 0) alert(country_regions[x][y] + " not found");
		}
	}	
}
...
s_a[59]="Arhus|Bornholm|Fredericksberg|Frederiksborg|Fyn|Kobenhavn|Nordjylland|Ribe|Ringkobing|Roskilde|Sonderjylland|Storstrom|Vejle|Vestsjalland|Viborg";
...
s_a[81]="Gaza Strip";
s_a[82]="Abashis|Abkhazia or Apkhazet is Avtonomiuri Respublika (Sokhumi)|Adigenis|Ajaria or Acharis Avtonomiuri Respublika (Bat umi)|Akhalgoris|Akhalk alak is|Akhalts ikhis|Akhmetis|Ambrolauris|Aspindzis|Baghdat is|Bolnisis|Borjomis|Ch khorotsqus|Ch okhatauris|Chiat ura|Dedop listsqaros|Dmanisis|Dushet is|Gardabanis|Gori|Goris|Gurjaanis|Javis|Karelis|K ut aisi|Kaspis|Kharagaulis|Khashuris|Khobis|Khonis|Lagodekhis|Lanch khut is|Lentekhis|Marneulis|Martvilis|Mestiis|Mts khet is|Ninotsmindis|Onis|Ozurgetis|Poti|Qazbegis|Qvarlis|Rustavi|Sachkheris|Sagarejos|Samtrediis|Senakis|Sighnaghis|Tbilisi|Telavis|Terjolis|Tetritsqaros|Tianetis|Tqibuli|Tsageris|Tsalenjikhis|Tsalkis|Tsqaltubo|Vanis|Zestaponis|Zugdidi|Zugdidis";
...
s_a[189]="Adygeya (Maykop)|Aginskiy Buryatskiy (Aginskoye)|Altay (Gorno-Altaysk)|Altayskiy (Barnaul)|Amurskaya (Blagoveshchensk)|Arkhangel skaya|Astrakhanskaya|Bashkortostan (Ufa)|Belgorodskaya|Bryanskaya|Buryatiya (Ulan-Ude)|Chechnya (Groznyy)|Chelyabinskaya|Chitinskaya|Chukotskiy (Anadyr)|Chuvashiya (Cheboksary)|Dagestan (Makhachkala)|Evenkiyskiy (Tura)|Ingushetiya (Nazran)|Irkutskaya|Ivanovskaya|Kabardino-Balkariya (Nal chik)|Kaliningradskaya|Kalmykiya (Elista)|Kaluzhskaya|Kamchatskaya (Petropavlovsk-Kamchatskiy)|Karachayevo-Cherkesiya (Cherkessk)|Kareliya (Petrozavodsk)|Kemerovskaya|Khabarovskiy|Khakasiya (Abakan)|Khanty-Mansiyskiy (Khanty-Mansiysk)|Kirovskaya|Komi (Syktyvkar)|Komi-Permyatskiy (Kudymkar)|Koryakskiy (Palana)|Kostromskaya|Krasnodarskiy|Krasnoyarskiy|Kurganskaya|Kurskaya|Leningradskaya|Lipetskaya|Magadanskaya|Mariy-El (Yoshkar-Ola)|Mordoviya (Saransk)|Moskovskaya|Moskva (Moscow)|Murmanskaya|Nenetskiy (Nar yan-Mar)|Nizhegorodskaya|Novgorodskaya|Novosibirskaya|Omskaya|Orenburgskaya|Orlovskaya (Orel)|Penzenskaya|Permskaya|Primorskiy (Vladivostok)|Pskovskaya|Rostovskaya|Ryazanskaya|Sakha (Yakutsk)|Sakhalinskaya (Yuzhno-Sakhalinsk)|Samarskaya|Sankt-Peterburg (Saint Petersburg)|Saratovskaya|Severnaya Osetiya-Alaniya [North Ossetia] (Vladikavkaz)|Smolenskaya|Stavropol skiy|Sverdlovskaya (Yekaterinburg)|Tambovskaya|Tatarstan (Kazan)|Taymyrskiy (Dudinka)|Tomskaya|Tulskaya|Tverskaya|Tyumenskaya|Tyva (Kyzyl)|Udmurtiya (Izhevsk)|Ulyanovskaya|Ust-Ordynskiy Buryatskiy (Ust-Ordynskiy)|Vladimirskaya|Volgogradskaya|Vologodskaya|Voronezhskaya|Yamalo-Nenetskiy (Salekhard)|Yaroslavskaya|Yevreyskaya";
